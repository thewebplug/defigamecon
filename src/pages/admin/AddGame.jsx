    ...
    <div className="admin-form">
      ...
      <div className="admin-form__main">
        ...
        >
          <div className="admin-form__main__form__flex">
            ...
            <div>
              ...
              {selectedCategories?.map((item) => (
                <div>{item} <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <label className="admin-form__main__form__upload-label">Videos(maximum size allowed: 15mb)</label>
